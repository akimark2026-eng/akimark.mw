// watch.js (Updated: secure HLS + HMAC signing like player.html)
(function() {
    'use strict';
    ...
    async function init() {
        ...
        try {
            ...
            // ── Attach HLS with HMAC signed loader
    ...
    video.addEventListener('loadedmetadata', () => {
        ...
        updateProgress();
        showLoader(false);
        // Schedule session refresh after first metadata
        // (will also be triggered by init)
    });
