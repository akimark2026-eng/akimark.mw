// non.js (v2 — matches home.js UI/UX exactly, spinner auto-clear on return)
...
(function() {
    ...
    // ════════════════════════════════════════════════════════════
    // IMAGE OPTIMIZATION (identical to home.js)
    // ════════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════════
    // MOVIE CARD — identical to home.js
    // ════════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════════
    // SMOOTH CROSSFADE (identical to home.js)
    // ════════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════════
    // TRANSLATORS — identical to home.js
    // ════════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════════
    // MY MOVIES COUNT (anonymous)
    // ════════════════════════════════════════════════════════════
    async function loadMyMoviesCount() {
        if (!myMoviesBadge) return;
        try {
    ...
    // ════════════════════════════════════════════════════════════
    // FETCH MOVIES — with crossfade from skeleton
    // ════════════════════════════════════════════════════════════
    ...
    function initInfiniteScroll() {
        ...
        if (!sentinel || sentinel._bound) return;
        sentinel._bound = true;
    ...
    // ════════════════════════════════════════════════════════════
    // CARD CLICK — navigate + spinner (with auto-clear on return)
    // ════════════════════════════════════════════════════════════
    function clearAllCardSpinners() {
    ...
    function initCardClick() {
        document.querySelectorAll('.movie-grid').forEach(function(grid) {
            ...
            grid.addEventListener('click', function(e) {
                ...
                setTimeout(function() {
                    window.location.href = 'non-view.html?id=' + movieId;
                }, 250);
            });
        });
    }
    ...
    // ════════════════════════════════════════════════════════════
    // 🆕 SPINNER AUTO-CLEAR (BF cache + visibilitychange)
    //   When user comes back from non-view.html, spinner
    //   yonse imachotsedwa kuti user apangenso click.
    // ════════════════════════════════════════════════════════════
    window.addEventListener('pageshow', function(e) {
        // pageshow fires on initial load AND on BF cache return
        clearAllCardSpinners();
    });
    window.addEventListener('visibilitychange', function() {
        if (!document.hidden) {
            // Page became visible again (user returned)
            clearAllCardSpinners();
        }
    });
    ...
    // ════════════════════════════════════════════════════════════
    // SCROLL EFFECTS (identical to home.js)
    // ════════════════════════════════════════════════════════════
        ...
        function updateScroll() {
            ...
            if (y < HIDE_AFTER) {
                if (isHidden) {
                    ...
                    if (translatorBar) translatorBar.classList.remove('hidden');
                    isHidden = false;
                }
            } else if (delta > 6 && !isHidden) {
                header.classList.add('hidden');
                if (subheader) subheader.classList.add('hidden');
                if (translatorBar) translatorBar.classList.add('hidden');
                isHidden = true;
            } else if (delta < -6 && isHidden) {
                header.classList.remove('hidden');
                if (subheader) subheader.classList.remove('hidden');
    ...
    // ════════════════════════════════════════════════════════════
    // EXPOSE HELPERS (same as home.js)
    // ════════════════════════════════════════════════════════════
