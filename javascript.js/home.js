// home.js (v9 — Smart skeleton + instant render, real emoji burst, pull-refresh)
...
(function() {
    ...
    // ════════════════════════════════════════════════════════════
    // 🆕 SMART SKELETON SHOW/HIDE
    //   • Skeleton imawoneka ngati fetch ikutenga >250ms
    //   • Ngati fetch ibwera msanga (<250ms), skeleton sichiwoneka
    //   • Zimathandiza kuti user asaone flicker
    // ════════════════════════════════════════════════════════════
    var skeletonTimeout = null;
    function showSkeletonIfSlow() {
        skeletonTimeout = setTimeout(function() {
            // Skeletons already in HTML — no action needed
        }, 250);
    }
    function clearSkeletonTimeout() {
        if (skeletonTimeout) {
    ...
    // ════════════════════════════════════════════════════════════
    // 🆕 PULL-TO-REFRESH (webview refresh)
    // ════════════════════════════════════════════════════════════
