// home.js (v8 — Ultra-speed posters, no skeleton blocking, live burst)
...
(function() {
    ...
    // ════════════════════════════════════════════════════════════
    // IMAGE OPTIMIZATION
    //   • Optimized URL when possible, fallback to original
    //   • Posters render instantly with placeholder gradient
    //   • Fade-in on load
    // ════════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════════
    // MOVIE CARD — instant render, poster fades in
    //   • Latest: first 8 images get eager + high priority
    //   • All:    first 4 images get eager + high priority
    //   • Rest:   lazy + low priority
    // ════════════════════════════════════════════════════════════
            ...
            if (entries[0].isIntersecting && !isLoadingMore) {
                ...
                setTimeout(function() {
                    ...
                    if (visibleCount < all.length) {
                        ...
                        // appended items → only first few eager
    ...
    // ════════════════════════════════════════════════════════════
    // SCROLL EFFECTS — hide on scroll down, show on scroll up
    // ════════════════════════════════════════════════════════════
